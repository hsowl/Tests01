...
//			.average().getAsDouble();
		...
		//2차원 배열을 1차원 배열로 변환해서 출력
		int[][] array = {{10,20},{30,40},{50,60}};
		
//		Stream<int[]> stm1 = Arrays.stream(array);
//		stm1.forEach(s -> System.out.println(s));
		
		Stream<int[]> str = Arrays.stream(array);
		str.flatMapToInt(t -> Arrays.stream(t)).forEach(s -> System.out.println(s));
